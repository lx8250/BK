<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"E:\BK/application/index\view\personal\personal.html";i:1526980811;s:47:"E:\BK\application\index\view\public\header.html";i:1545356743;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<header>
    ...
    <div class="row" style="margin-left: 20%;margin-right: -9%">
        <ul class="layui-nav layui-bg-cyan" style="padding-top: 0px">
            ...
            <li class="layui-nav-item"><a href="<?php echo url('/index/pay/index'); ?>">支付界面</a></li>
